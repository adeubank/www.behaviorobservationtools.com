  ...
  return <Layout>
    <div className={styles.grid}>
      <div className={styles.code}>
        ...
        <p>Your privacy is important to us. It is Allen Eubank Technology's policy to respect your privacy regarding any information we may collect from you through our app, Behavior Observation: BOSS.</p>

        <h3>Types of Data We Collect</h3>

        <p>We use the following data for app functionality and usage analytics.</p>
        ...
        <p>Student, school, and observation session data is only transferred off the device in the event of an app crash to aid in troubleshooting app usage issues and as necessary to provide you with your requested service. This information is not used for any other purpose.</p>
        ...
        <footer style={{ fontSize: '0.6rem' }}>
          <ol>
            <li id="1"><small>PTAC-CL, Sep 2012 <a target="_blank" href="https://studentprivacy.ed.gov/sites/default/files/resource_document/file/checklist_data_breach_response_092012_0.pdf" rel="nofollow">https://studentprivacy.ed.gov/sites/default/files/resource_document/file/checklist_data_breach_response_092012_0.pdf</a></small></li>
          </ol>
        </footer>
      </div>
    </div>
